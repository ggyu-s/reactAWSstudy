  ...
  return produce(state, (draft) => {
    switch (action.type) {
      ...
      case ADD_COMMENT_SUCCESS: {
        ...
        post.Comments.unshift(dummyConmment(action.data));
